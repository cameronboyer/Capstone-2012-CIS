            ...
            <asp:MultiView ID="copyJob" runat="server">
                <asp:View ID="C_clientInfo" runat="server">
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="C_toNamingPage" runat="server" onclick="C_addNext_Click" 
                                        Text="Go to Control Number Naming" />
                                </td>
                            </tr>
                        </table>
                </asp:View>
                <asp:View ID="C_scanning" runat="server">
                        <h1>Scanning</h1>
                        <table style="width: 100%;">
                            <tr>
                                <td class="style44" colspan="2">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="C_backToGrouping" runat="server" Text="Back" />
                                </td>
                                <td>
                                
                                </td>
                                <td>
                                    <asp:Button ID="C_goToMedia" runat="server" onclick="C_goToMedia_Click" Text="Go to Media" />
                                </td>
                            </tr>
                        </table>
                    </asp:View>
                <asp:View ID="C_specialInstructions" runat="server">
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="style67">
                                &nbsp; Data</td>
                            <td colspan="2" rowspan="8">
                                <asp:TextBox ID="C_specialInstrctionsDataTextBox" runat="server" Height="165px" TextMode="MultiLine" 
                                    Width="675px"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <table>
                            <tr>
                                <td>
                                    <asp:Button ID="C_backToPrinting" runat="server" Text="Back" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
            ...
            <asp:MultiView ID="dataJob" runat="server">
                <asp:View ID="D_clientInfo" runat="server">
                        ...
                        <table style="width: 100%;">
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="D_toNamingPage" runat="server" onclick="D_addNext_Click" 
                                        Text="Go to Control Number Naming" />
                                </td>
                            </tr>
                        </table>
                ...
                <asp:View ID="D_naming" runat="server">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="D_toDocumentLevel" runat="server" Text="Go to Document Level" onclick="D_toDocumentLevel_Click" />
                                </td>
                            </tr>
                        </table>    
                    </asp:View>
                <asp:View ID="D_deliverable" runat="server">
                    <h1>Deliverable</h1>
                            ...
                            <tr>
                                <td>
                                    <asp:Button ID="D_backToMedia" runat="server" Text="Back" />
                                </td>
                                <td>
                                
                                </td>
                                <td>
                                    <asp:Button ID="D_gotoIndexingInstructions" runat="server" onclick="D_gotoIndexingInstructions_Click" Text="Go to Indexing Instructions" />
                                </td>
                            </tr>
                        </table>
                    </asp:View>
                <asp:View ID="D_ebsInstructions" runat="server">
                    <h1>EBS Instructions</h1>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <asp:Button ID="D_backToIndexing" runat="server" Text="Back" />
                                </td>
                                <td>
                    ...
                    <h1>Printing/Blowbacks</h1>
                        ...
                        <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Button ID="D_goToSpecialInstructions" runat="server" Text="Go to Special Instructions" />
                                    </td>
                                </tr>
                            </table>
                    </asp:View>
                        ...
                        <table style="width: 100%;">
                            <tr>
                                <td class="style67">
                                    &nbsp; Production</td>
                                <td colspan="2" rowspan="4">
                                    &nbsp;<asp:TextBox ID="D_sepcialInstrctionsProductionTextBox" runat="server" Height="165px" TextMode="MultiLine" 
                                        Width="675px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
